...
class vggTrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--refine_iteration', type=int, default=1, help='0:不要refine网络;1:是原始的方法，只有一次计算;2以上:就是refine网路的迭代次数')
		self.parser.add_argument('--name', type=str, default='n10_train_300_2mix_vggsound',
		...
		self.parser.add_argument('--vggsound', type=bool, default=True)
