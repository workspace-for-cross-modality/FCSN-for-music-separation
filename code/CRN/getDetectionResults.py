...
def parse_args():
  ...
  parser.add_argument('--load_dir', dest='load_dir',
                      ...
                      default="models/pretrain_model")
  parser.add_argument('--image_dir', dest='image_dir',
                      help='directory to load images for demo',
                      default="/home/mashuo/work/study/faster-rcnn.pytorch/images")
...
if __name__ == '__main__':
  ...
  load_name = 'models/pretrain_model/faster_rcnn_musical_instruments.pth'
  ...
  detection_dir = '/home/mashuo/work/study/co-separation/results/detection'
  detection_results_dir = '/home/mashuo/work/study/co-separation/results'
...
if count > 0:
	np.save(os.path.join(detection_results_dir, 'result.npy'), array2save)